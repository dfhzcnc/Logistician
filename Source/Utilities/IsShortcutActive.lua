...
local function isLeftClickShortcutActive(shortcutOption, button)
  return
    shortcutOption == Logistician.Config.Shortcuts.LEFT_CLICK and button == LEFT_BUTTON and
...
local function isRightClickShortcutActive(shortcutOption, button)
  return
    shortcutOption == Logistician.Config.Shortcuts.RIGHT_CLICK and button == RIGHT_BUTTON and
    not IsShiftKeyDown() and not IsAltKeyDown() and not IsControlKeyDown()
end

local function isAltLeftClickShortcutActive(shortcutOption, button)
  return
    shortcutOption == Logistician.Config.Shortcuts.ALT_LEFT_CLICK and button == LEFT_BUTTON and
...
local function isAltRightClickShortcutActive(shortcutOption, button)
  return
    shortcutOption == Logistician.Config.Shortcuts.ALT_RIGHT_CLICK and button == RIGHT_BUTTON and
    not IsShiftKeyDown() and IsAltKeyDown() and not IsControlKeyDown()
end

local function isShiftLeftClickShortcutActive(shortcutOption, button)
  return
    shortcutOption == Logistician.Config.Shortcuts.SHIFT_LEFT_CLICK and button == LEFT_BUTTON and
...
local function isShiftRightClickShortcutActive(shortcutOption, button)
  return
    shortcutOption == Logistician.Config.Shortcuts.SHIFT_RIGHT_CLICK and button == RIGHT_BUTTON and
    IsShiftKeyDown() and not IsAltKeyDown() and not IsControlKeyDown()
end

function Logistician.Utilities.IsShortcutActive(shortcutOption, button)
  return
