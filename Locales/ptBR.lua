...
L["BUG_TOOLTIP_TEXT"] = "Se você encontrar um erro ao usar o Logistician, reporte no Github. Forneça detalhes suficientes para que possamos reproduzí-lo. Usar os AddOns !BugGrabber e BugSack também nos ajudará."
L["BUY"] = "Comprar"
...
L["CANCELLING_TAB_HEADER"] = "Logistician - Cancelar"
...
L["CONFIG_BASIC_OPTIONS_TEXT"] = "Opções básicas para ativar recursos no Logistician."
...
L["CONFIG_CRAFTING_INFO_SHOW_CHEAPEST_QUALITIES_COST_TOOLTIP_TEXT"] = "Ative esta opção para ver o custo de fabricação de uma receita específica usando reagentes de qualidade mais barata ao visualizá-la. Por padrão, o Logistician prioriza os reagentes em sua bolsa, mas este valor os ignorará."
...
L["CONFIG_DEBUG_TOOLTIP_HEADER"] = "Debug do Logistician"
...
L["CONFIG_SELLING_GEAR_VENDOR_PRICE_MULTIPLIER_TOOLTIP_TEXT"] = "Isso permite definir um preço padrão para o equipamento como um múltiplo do preço do vendedor. Isso é usado para qualquer equipamento para o qual o Logistician não tenha um preço. Marque 0 para não definir um preço."
...
L["CONTRIBUTE_TOOLTIP_TEXT"] = "Logistician teve milhares de horas investidas em desenvolvimento e suporte para atingir seu estado atual nos últimos anos. Fazer uma doação é uma forma de apoiar este projeto indefinidamente."
...
L["DISCORD_TOOLTIP_TEXT"] = "Nós temos uma comunidade bem ativa para usuários do Logistician que pode ajudar a responder quaisquer perguntas que você pode ter."
L["DISENCHANT"] = "Desencantar"
L["DONATE"] = "Doar"
L["DURATION"] = "Duração"
L["EDIT_ITEM"] = "Editar Item"
L["ENGAGE_HEADER"] = "Engajar Com o Logistician"
...
L["INFO_TAB_HEADER"] = "Logistician - Informações"
...
L["PROFILE_TOGGLE_TOOLTIP_TEXT"] = "Faz mudanças para as configurações do Logistician afetar apenas este personagem."
...
L["ROADMAP_TOOLTIP_TEXT"] = "O roteiro técnico define as melhorias que planejamos para futuras atualizações do Logistician. Por favor olhe aqui para se informar sobre o progresso feito na sua função favorita!"
...
L["SELLING_TAB_HEADER"] = "Logistician - Vendas"
...
L["SHOPPING_TAB_HEADER_2"] = "Logistician - Compras"
L["SKIP"] = "Pular"
L["SORT"] = "Ordenar"
