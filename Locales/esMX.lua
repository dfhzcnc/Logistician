...
L["CONFIG_CRAFTING_INFO_SHOW_CHEAPEST_QUALITIES_COST_TOOLTIP_TEXT"] = "Activa esta opción para ver el coste de fabricación de una receta usando los componentes de peor calidad. De forma predeterminada Logistician prioriza los componentes de tus bolsas, pero esta opción los ignorará."
