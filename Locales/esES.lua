LOGISTICIAN_LOCALES.esES = function()
  local L = {}
...
L["BUG_TOOLTIP_TEXT"] = "Si encuentras un error mientras usas Logistician, por favor repórtalo en Github. ¡Proporciona suficientes detalles para que podamos reproducir el error! Usar los addons !BugGrabber y BugSack también nos ayudará."
L["BUY"] = "Comprar"
...
L["CANCELLING_TAB_HEADER"] = "Logistician - Cancelado"
...
L["CONFIG_BASIC_OPTIONS_TEXT"] = "Opciones básicas para habilitar funciones en Logistician."
...
L["CONFIG_CRAFTING_INFO_SHOW_CHEAPEST_QUALITIES_COST_TOOLTIP_TEXT"] = "Activa esta opción para ver el coste de fabricación de una receta usando los componentes de peor calidad. Por defecto, Logistician prioriza los componentes de tus bolsas, pero esta opción los ignorará."
...
L["CONFIG_SELLING_GEAR_VENDOR_PRICE_MULTIPLIER_TOOLTIP_TEXT"] = "Esto le permite establecer un precio predeterminado para el equipo como un múltiplo del precio del vendedor. Esto se utiliza para cualquier equipo por el que Logistician no tenga precio. Configure esto en 0 para no establecer un precio."
...
L["CONTRIBUTE_TOOLTIP_TEXT"] = "Logistician ha requerido miles de horas de desarrollo y soporte para llegar a su estado actual en los últimos años. Donar es una forma de apoyar este proyecto de manera indefinida."
...
L["DISCORD_TOOLTIP_TEXT"] = "Tenemos una comunidad activa de usuarios de Logistician que pueden ayudarte a resolver cualquier duda que puedas tener."
L["DISENCHANT"] = "Desencantar"
L["DONATE"] = "Donar"
L["DURATION"] = "Duración (Horas)"
L["EDIT_ITEM"] = "Editar objeto"
L["ENGAGE_HEADER"] = "Iniciar con Logistician"
...
L["INFO_TAB_HEADER"] = "Logistician - Información"
...
L["PROFILE_TOGGLE_TOOLTIP_TEXT"] = "Los cambios en la configuración de Logistician solo afectan a este personaje."
...
L["ROADMAP_TOOLTIP_TEXT"] = [=[El cronograma técnico definió el trabajo que hemos planeado para los próximos lanzamientos de Logistician. ¡Compruebe aquí el progreso de la implementación hacia su característica favorita!
]=]
...
L["SELLING_TAB"] = "Venta"
L["SELLING_TAB_HEADER"] = "Logistician - Venta"
