AUCTIONATOR_LOCALES.enUS = function()
  ...
  L["CONFIG_BASIC_OPTIONS_TEXT"] = "Basic options for enabling features in Logistician."
  ...
  L["ENGAGE_HEADER"] = "Engage With Logistician"
  L["DISCORD"] = "Discord"
  L["DISCORD_TOOLTIP_HEADER"] = "Join us in Discord!"
  L["DISCORD_TOOLTIP_TEXT"] = "We have an active community of Logistician users that can help answer any questions you might have."
  L["BUG_REPORT"] = "Report a Bug"
  L["BUG_TOOLTIP_HEADER"] = "Report a Bug on Github"
  L["BUG_TOOLTIP_TEXT"] = "If you encounter an error while using Logistician, please report on Github. Please provide enough details so that we can reproduce the bug! Using !BugGrabber and BugSack addons will help us as well."
  L["ROADMAP"] = "Technical Roadmap"
  L["ROADMAP_TOOLTIP_TEXT"] = "The technical roadmap defined the work we have planned for upcoming releases of Logistician. Please check here for implementation progress towards your favorite feature!"
  ...
  L["SALE_LIKELIHOOD"] = "Sale likelihood"
  L["MODEL_CONFIDENCE"] = "Model confidence"
  ...
  L["SHOPPING_TAB_HEADER_2"] = "Logistician - Shopping"
  L["INFO_TAB_HEADER"] = "Logistician - Info"

  L["OPEN_IN_SHOPPING_TAB"] = "Open in Shopping Tab"

  L["SELLING_TAB"] = "Selling"
  L["SELLING_TAB_HEADER"] = "Logistician - Selling"

  L["CANCELLING_TAB"] = "Cancelling"
  L["CANCELLING_TAB_HEADER"] = "Logistician - Cancelling"
  ...
  L["LIST_EXTENDED_SEARCH_HEADER"] = "Advanced Search Options"
  ...
  L["PROFILE_TOGGLE_TOOLTIP_TEXT"] = "Makes changes to the Logistician settings only affect this character."
  ...
  L["CONFIG_CRAFTING_INFO_SHOW_CHEAPEST_QUALITIES_COST_TOOLTIP_TEXT"] = "Enable this option to see the cost of crafting a specific recipe using the cheapest quality reagents when viewing it. By default Logistician prioritises the reagents in your bags, but this value will ignore them."
  ...
  L["CONFIG_SELLING_GEAR_VENDOR_PRICE_MULTIPLIER_TOOLTIP_TEXT"] = "This lets you set a default price for gear as a multiple of the vendor price. This is used for any gear Logistician doesn't have a price for. Set this to 0 to not set a price."
