...
function AuctionatorTabMixin:Selected()
  ...
  AuctionFrameTopLeft:SetTexture("Interface\\AddOns\\!Logistician\\Images_Classic\\topleft");
  AuctionFrameTop:SetTexture("Interface\\AddOns\\!Logistician\\Images_Classic\\top");
  AuctionFrameTopRight:SetTexture("Interface\\AddOns\\!Logistician\\Images_Classic\\topright");
  AuctionFrameBotLeft:SetTexture("Interface\\AddOns\\!Logistician\\Images_Classic\\botleft");
  AuctionFrameBot:SetTexture("Interface\\AddOns\\!Logistician\\Images_Classic\\bot");
  AuctionFrameBotRight:SetTexture("Interface\\AddOns\\!Logistician\\Images_Classic\\botright");
end
