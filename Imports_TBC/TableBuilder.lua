...
LogisticianTBCImportTableBuilderElementMixin = {};

--Derive
function LogisticianTBCImportTableBuilderElementMixin:Init(...)
end

--Derive
function LogisticianTBCImportTableBuilderElementMixin:Populate(rowData, dataProviderKey)
end

LogisticianTBCImportTableBuilderCellMixin = CreateFromMixins(LogisticianTBCImportTableBuilderElementMixin);

--Derive
function LogisticianTBCImportTableBuilderCellMixin:OnLineEnter()
end

--Derive
function LogisticianTBCImportTableBuilderCellMixin:OnLineLeave()
end


LogisticianTBCImportTableBuilderRowMixin = CreateFromMixins(LogisticianTBCImportTableBuilderElementMixin);

--Derive
function LogisticianTBCImportTableBuilderRowMixin:OnLineEnter()
end

--Derive
function LogisticianTBCImportTableBuilderRowMixin:OnLineLeave()
end


function LogisticianTBCImportTableBuilderRowMixin:OnEnter()
	self:OnLineEnter();
...
function LogisticianTBCImportTableBuilderRowMixin:OnLeave()
	self:OnLineLeave();
	for i, cell in ipairs(self.cells) do
		cell:OnLineLeave();
	end
...
LogisticianTBCImportTableBuilderColumnMixin = {};
function LogisticianTBCImportTableBuilderColumnMixin:Init(table)
	self.cells = {};
	self.table = table;
...
function LogisticianTBCImportTableBuilderColumnMixin:ConstructHeader(templateType, template, ...)
...
function LogisticianTBCImportTableBuilderColumnMixin:Reset()
...
function LogisticianTBCImportTableBuilderColumnMixin:RemoveRow(row)
	local cell = self.cells[row];
	self.cells[row] = nil;
	self.pool:Release(cell);
end

function LogisticianTBCImportTableBuilderColumnMixin:ConstructCell(row, rowData, dataProviderKey)
...
function LogisticianTBCImportTableBuilderColumnMixin:ConstructCells(templateType, template, ...)
	self.args = {...};

	self.pool = ColumnFramePoolCollection:GetOrCreatePool(templateType, nil, template);
end

function LogisticianTBCImportTableBuilderColumnMixin:GetFillCoefficient()
	return self.fillCoefficient;
end

function LogisticianTBCImportTableBuilderColumnMixin:SetFillCoefficient(fillCoefficient)
	self.fillCoefficient = fillCoefficient;
end

function LogisticianTBCImportTableBuilderColumnMixin:GetPadding()
	return self.padding;
end

function LogisticianTBCImportTableBuilderColumnMixin:SetPadding(padding)
	self.padding = padding;
end

function LogisticianTBCImportTableBuilderColumnMixin:GetCellPadding()
	return self.leftCellPadding or 0, self.rightCellPadding or 0;
end

function LogisticianTBCImportTableBuilderColumnMixin:SetCellPadding(leftCellPadding, rightCellPadding)
	self.leftCellPadding = leftCellPadding;
	self.rightCellPadding = rightCellPadding;
end

function LogisticianTBCImportTableBuilderColumnMixin:GetHeaderFrame()
	return self.headerFrame;
end

function LogisticianTBCImportTableBuilderColumnMixin:SetHeaderFrame(headerFrame)
	self.headerFrame = headerFrame;
end

function LogisticianTBCImportTableBuilderColumnMixin:GetWidthConstraints()
	return self.widthConstraints;
end

function LogisticianTBCImportTableBuilderColumnMixin:GetFixedWidth()
...
function LogisticianTBCImportTableBuilderColumnMixin:ConstrainToHeader(padding)
...
function LogisticianTBCImportTableBuilderColumnMixin:SetFixedConstraints(fixedWidth, padding)
...
function LogisticianTBCImportTableBuilderColumnMixin:SetFillConstraints(fillCoefficient, padding)
...
function LogisticianTBCImportTableBuilderColumnMixin:SetCalculatedWidth(calculatedWidth)
	self.calculatedWidth = calculatedWidth;
end

function LogisticianTBCImportTableBuilderColumnMixin:GetCalculatedWidth()
	return self.calculatedWidth;
end

function LogisticianTBCImportTableBuilderColumnMixin:GetCellWidth()
	local leftCellPadding, rightCellPadding = self:GetCellPadding();
	return (self.calculatedWidth - leftCellPadding) - rightCellPadding;
end

function LogisticianTBCImportTableBuilderColumnMixin:GetFullWidth()
	return self:GetCalculatedWidth() + self:GetPadding();
end

function LogisticianTBCImportTableBuilderColumnMixin:SetDisplayUnderPreviousHeader(displayUnderPreviousHeader)
	self.displayUnderPreviousHeader = displayUnderPreviousHeader;
end

function LogisticianTBCImportTableBuilderColumnMixin:GetDisplayUnderPreviousHeader()
...
LogisticianTBCImportTableBuilderMixin = {};
function LogisticianTBCImportTableBuilderMixin:Init()
	self.rows = {};
	self.columns = {};
	self.leftMargin = 0;
	self.rightMargin = 0;
...
function LogisticianTBCImportTableBuilderMixin:GetDataProvider()
	return self.dataProvider;
end

function LogisticianTBCImportTableBuilderMixin:SetDataProvider(dataProvider)
	self.dataProvider = dataProvider;
end

function LogisticianTBCImportTableBuilderMixin:GetDataProviderData(dataProviderKey)
...
function LogisticianTBCImportTableBuilderMixin:SetTableMargins(leftMargin, rightMargin)
...
function LogisticianTBCImportTableBuilderMixin:SetColumnHeaderOverlap(columnHeaderOverlap)
...
function LogisticianTBCImportTableBuilderMixin:SetTableWidth(tableWidth)
	self.tableWidth = tableWidth;
end

function LogisticianTBCImportTableBuilderMixin:GetTableWidth()
	return self.tableWidth;
end

function LogisticianTBCImportTableBuilderMixin:GetTableMargins()
	return self.leftMargin, self.rightMargin;
end

function LogisticianTBCImportTableBuilderMixin:GetColumnHeaderOverlap()
	return self.columnHeaderOverlap;
end

function LogisticianTBCImportTableBuilderMixin:GetColumns()
	return self.columns;
end

function LogisticianTBCImportTableBuilderMixin:GetHeaderContainer()
	return self.headerContainer;
end

function LogisticianTBCImportTableBuilderMixin:SetHeaderContainer(headerContainer)
...
function LogisticianTBCImportTableBuilderMixin:GetHeaderPoolCollection()
	return self.headerPoolCollection;
end

function LogisticianTBCImportTableBuilderMixin:EnumerateHeaders()
	return self.headerPoolCollection:EnumerateActive();
end

function LogisticianTBCImportTableBuilderMixin:ConstructHeader(templateType, template)
	local headerContainer = self:GetHeaderContainer();
	assert(headerContainer ~= nil, "A header container must be set with LogisticianTBCImportTableBuilderMixin:SetHeaderContainer before adding column headers.")
...
function LogisticianTBCImportTableBuilderMixin:Arrange()
...
function LogisticianTBCImportTableBuilderMixin:Reset()
...
function LogisticianTBCImportTableBuilderMixin:AddRow(row, dataProviderKey)
...
function LogisticianTBCImportTableBuilderMixin:RemoveRow(row)
...
function LogisticianTBCImportTableBuilderMixin:ArrangeCells(row)
	local columns = self:GetColumns();
	if #columns == 0 then
		return;
	end
...
function LogisticianTBCImportTableBuilderMixin:AddColumn()
	local column = CreateAndInitFromMixin(LogisticianTBCImportTableBuilderColumnMixin, self);
	tinsert(self.columns, column);
	return column;
end

function LogisticianTBCImportTableBuilderMixin:CalculateColumnSpacing()
...
function LogisticianTBCImportTableBuilderMixin:ArrangeHorizontally(frame, relativeTo, width, pointTop, pointRelativeTop, pointBottom, pointRelativeBottom, xOffset)
...
function LogisticianTBCImportTableBuilderMixin:ArrangeHeaders()
...
function LogisticianTBCImportCreateTableBuilder(rows, ...)
	local tableBuilder = CreateAndInitFromMixin(LogisticianTBCImportTableBuilderMixin, rows);
	Mixin(tableBuilder, ...);
	return tableBuilder;
end
