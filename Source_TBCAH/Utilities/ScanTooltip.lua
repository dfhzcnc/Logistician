local tooltip = CreateFrame("GameTooltip", "LogisticianUtilitiesScanTooltipTooltip", nil, "GameTooltipTemplate")
...
function Logistician.Utilities.ScanTooltip(tooltipSet, tooltipCheck)
  tooltip:SetOwner(WorldFrame, "ANCHOR_NONE")
  tooltipSet(tooltip)
