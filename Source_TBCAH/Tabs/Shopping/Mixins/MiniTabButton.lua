...
LogisticianShoppingListsMiniTabButtonMixinMixin = {}

function LogisticianShoppingListsMiniTabButtonMixinMixin:OnLoad()
  self.LeftDisabled:SetPoint("TOPLEFT")
  self.deselectedTextY = 6
  self.selectedTextY = 2
end

function LogisticianShoppingListsMiniTabButtonMixinMixin:OnShow()
  local absoluteSize = nil
  PanelTemplates_TabResize(self, TAB_PADDING, absoluteSize, MIN_TAB_WIDTH)
end

function LogisticianShoppingListsMiniTabButtonMixinMixin:OnClick()
